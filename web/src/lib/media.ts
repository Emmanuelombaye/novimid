...
export const media = {
  hero: {
    desktop: {
      ...
      alt: "Healthy couple in a California home representing physician-directed health optimization with novimid",
      width: 1024,
      height: 1024,
    ...
    mobile: {
      ...
      alt: "Healthy couple representing physician-directed health optimization with novimid",
      width: 900,
      height: 1350,
