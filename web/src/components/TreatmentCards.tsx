...
const cards = [
  {
    ...
    body: "A clinician-guided Semaglutide program for weight management when clinically appropriate. Completing intake does not guarantee a prescription.",
    vial: "/images/card-vial-semaglutide.png",
    vialAlt: "Illustrative Semaglutide product photo",
    stage: "bg-[#E7F0E8]",
  ...
  },
  {
    ...
    body: "A clinician-guided Tirzepatide program for weight management when clinically appropriate. Completing intake does not guarantee a prescription.",
    vial: "/images/card-vial-tirzepatide.png",
    vialAlt: "Illustrative Tirzepatide product photo",
    stage: "bg-[#EAF2EC]",
